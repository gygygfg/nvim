...
function M.setup()
    ...
    -- 窗口管理
    _set_keymap("n", "<C-h>", "<C-w>h") -- 切换到左窗口
    _set_keymap("n", "<C-j>", "<C-w>j") -- 切换到下窗口
    _set_keymap("n", "<C-k>", "<C-w>k") -- 切换到上窗口
    _set_keymap("n", "<C-l>", "<C-w>l") -- 切换到右窗口

    -- 缓冲区
    _set_keymap("n", "<leader>bn", ":bnext<CR>")     -- 下一个缓冲区
    _set_keymap("n", "<leader>bp", ":bprevious<CR>") -- 上一个缓冲区
    _set_keymap("n", "<leader>bd", ":bdelete<CR>")   -- 关闭缓冲区
end
